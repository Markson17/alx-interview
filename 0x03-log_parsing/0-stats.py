...
# The above line is called a shebang and indicates the path to the Python interpreter to use when running the script.
# The triple quotes indicate a multi-line string used as a docstring to describe the script's purpose.
